#calling for a random generator, and importing from the operating os. 
from random import randint
# creating a function randint() 
import os
# creating a ship 
class Ship:
    def __init__(self, size, orientation, location):
        ...
        if orientation == 'horizontal' or  orientation == 'vertical':
            ...
            raise ValueError("value must be 'horizontal' or 'verticle'.")
        ...
        if orientation == 'horizontal':
            if location['row'] in range(row_size):
                ...
                for index in range(size):
                  ...
                  raise IndexError("Row is out range.")
...
#Setting Variables
row_size = 7 #number of rows
col_size = 7 #number of columns
num_ships = 4
max_ship_size = 5
min_ship_size = 2
num_turns = 40
...
board_display = [['0'] * col_size for x in range(row_size)]
    ...
    while True:
        try:
            ...
            if guess in range(1, row_size + 1):
                ...
                print("\nOoops, please endter a number on the board")
        except ValueError:
...
for turn in range (num_turns):
    ...
    while True:
        ...
        if board_display[guess_coords['row']][guess_coords['col']] == 'X' or \
            ...
            print("\nYou guessed that one already.Stoopid")
        else:
            break
